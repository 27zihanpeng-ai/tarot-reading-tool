export const tarotCards = [
  { 
    ...
    detailedMeaningZh: {
      upright: '勇敢迈出第一步，拥抱未知的可能性，充满热情地面对不确定性。预示新的冒险、崭新的开始和勇气。',
      reversed: '莽撞，判断失误，忽视警告，天真。未经思考就采取行动，冒不必要的风险，或拒绝听取建议。'
    }
  },
  { 
    number: 1, 
    ...
    detailedMeaningZh: {
      upright: '显现你的愿望，个人力量，熟练的沟通。你拥有所需的一切工具。这是采取行动并信任自己能力的时刻。',
      reversed: '操纵，计划不周，缺乏方向，未被发掘的潜力。对自己的道路感到困惑或缺乏信心来有效地运用你的才能。'
    }
  },
  { 
    number: 2, 
    ...
    detailedMeaningZh: {
      upright: '相信你的直觉，聆听内心的智慧，潜意识显现自身。秘密即将被揭露，谜团将通过直觉而非逻辑来解决。',
      reversed: '被压抑的直觉，困惑，缺乏内省，无法获取内心智慧。你可能忽视了重要的心理信号或过于相信外部声音。'
    }
  },
  { 
    number: 3, 
    ...
    detailedMeaningZh: {
      upright: '创意、丰富、滋养能量、增长和繁荣。代表观念和项目的肥沃性。美丽、快乐和物质舒适的时刻。',
      reversed: '创意缺乏、增长受阻、依赖问题或生育困难。可能忽视了自我护理或创意表达。'
    }
  },
  { 
    number: 4, 
    ...
    detailedMeaningZh: {
      upright: '权威、权力、领导力、结构和控制。你处于力量的位置。建立秩序、设定界限并采取果断行动的时刻。',
      reversed: '权威缺失、虚弱、专制或权力滥用。失去控制或与专制人物抗争。'
    }
  },
  { 
    number: 5, 
    ...
    detailedMeaningZh: {
      upright: '传统、精神智慧、宗教信仰、道德价值观。导师或精神领袖出现。专注于既定的实践和社会规范的一致性。',
      reversed: '反抗传统、个人信念优于制度教条、非常规的精神道路。打破限制性的系统。'
    }
  },
  { 
    number: 6, 
    ...
    detailedMeaningZh: {
      upright: '爱、和谐、关系、关于价值观的重要选择。代表你的行动与信念的一致性。可能表示浪漫爱情或深层联系。',
      reversed: '冲突、沟通不畅、价值观不一致。关系挑战或关于什么对你真正重要的困难决定。'
    }
  },
  { 
    number: 7, 
    ...
    detailedMeaningZh: {
      upright: '胜利、意志力、决心、对环境的控制。信心前进的标志。努力和决心将导致成功。',
      reversed: '缺乏控制、能量分散、无方向。感到不知所措或失去对情况的控制。难以保持专注。'
    }
  },
  { 
    number: 8, 
    ...
    detailedMeaningZh: {
      upright: '内在力量、勇气、耐心和控制。你有能力通过温和的决心克服挑战。对内在力量的信心。',
      reversed: '自我怀疑、虚弱、不安全感或严厉的自我批评。你可能低估了自己的韧性和能力。'
    }
  },
  { 
    number: 9, 
    ...
    detailedMeaningZh: {
      upright: '内省、内在指导、精神寻求。向内看并从灵魂寻求答案的时刻。通过独处和反思获得的智慧。',
      reversed: '孤立、孤独、退缩行为。或在需要时拒绝寻求帮助。是时候重新与他人和周围的世界联系。'
    }
  },
  { 
    number: 10, 
    ...
    detailedMeaningZh: {
      upright: '好运、命运、因果、生命循环。转折点即将来临。什么上升必须下降，反之亦然。接纳变化和自然节奏。',
      reversed: '厄运、混乱、循环被打乱。抵抗变化或感到被环境困住。打破不再为你服务的模式。'
    }
  },
  { 
    number: 11, 
    ...
    detailedMeaningZh: {
      upright: '真理、因果关系、问责、法律事项得以公平解决。做出诚实决定和平衡判断的时刻。因果报应起作用。',
      reversed: '不公正、不诚实、不公平环境、有偏见的判断。法律麻烦或真相被隐瞒的情况。'
    }
  },
  { 
    number: 12, 
    ...
    detailedMeaningZh: {
      upright: '暂停、视角转变、判断的中止。放手那些不再为你服务的东西的时刻。为了获得更大的理解或精神收获而牺牲。',
      reversed: '冷漠、停滞、避免必要的改变、固执。无法或不愿做出牺牲。拒绝向新环境屈服。'
    }
  },
  { 
    number: 13, 
    ...
    detailedMeaningZh: {
      upright: '变化、结束和新开始、过渡、蜕变。不是字面上的死亡，而是必要变革和重生的象征。关闭一章来打开另一章。',
      reversed: '停滞、对变化的恐惧、抵抗转变。坚持已经结束的事物或拒绝接受必要的过渡。'
    }
  },
  { 
    number: 14, 
    ...
    detailedMeaningZh: {
      upright: '平衡、节制、耐心、和谐。找到中间之路，融合不同元素。保持冷静、耐心和平衡方法的时刻。',
      reversed: '失衡、过度、不耐烦、不和谐。失去适度意识或在生活中苦恼寻找和谐。内部或外部冲突。'
    }
  },
  { 
    number: 15, 
    ...
    detailedMeaningZh: {
      upright: '束缚、物质主义、玩心、超脱。你可能被限制性信念或不健康的依恋所困。提醒检查你的价值观和优先事项。',
      reversed: '摆脱束缚、自由、打破限制。识别并逃脱有毒模式或依赖。'
    }
  },
  { 
    number: 16, 
    ...
    detailedMeaningZh: {
      upright: '突然动荡、混乱、启示、旧结构的破裂。塔的时刻——生活摇晃以显示真理。尽管痛苦，这为重建铺平了道路。',
      reversed: '灾难避免、防止冲突、维持现状。或延迟与不可避免的变化的对峙。'
    }
  },
  { 
    number: 17, 
    ...
    detailedMeaningZh: {
      upright: '希望、信心、目的、重新获得兴趣。黑暗中的指引光芒，精神灵感。相信更好的时光即将到来并追随你的梦想。',
      reversed: '失去信心、绝望、缺乏希望或方向。感到与你的目的脱节或无法看到前方的光芒。'
    }
  },
  { 
    number: 18, 
    ...
    detailedMeaningZh: {
      upright: '幻觉、恐惧、焦虑、直觉、梦想。事情并不如看起来那样。相信你的直觉但要意识到自欺欺人。创意和想象力蓬勃发展。',
      reversed: '清晰、真相揭露、恐惧减退、误解消除。雾散开，你清楚地看到现实。'
    }
  },
  { 
    number: 19, 
    ...
    detailedMeaningZh: {
      upright: '快乐、成功、活力、幸福、乐观主义。表示清晰和成就的积极卡牌。生活很好，丰盛流动。温暖和光线环绕你。',
      reversed: '悲伤、延迟、悲观主义、短暂的云层遮住太阳。或虚假的希望和不切实际的期望。'
    }
  },
  { 
    number: 20, 
    ...
    detailedMeaningZh: {
      upright: '觉醒、清算、内心的召唤、赦免。第二次机会或重要的人生决定。回应更高召唤和评估你人生方向的时刻。',
      reversed: '自我怀疑、严厉的内心批评、忽视召唤、避免决定。拖延或害怕采取那重要的一步。'
    }
  },
  { 
    number: 21, 
    ...
    detailedMeaningZh: {
      upright: '完成、满足、成就、结束。一个循环已成功结束。你已实现目标并达到自然结束。为新开始做好准备。',
      reversed: '不完整、未竟事业、寻求结束、延迟。某些事情不完整或未解决。需要最后努力来完成你开始的事情。'
    }
  },
];
